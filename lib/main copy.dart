...
class _DemoPageState extends State<DemoPage> {
  ...
  _onScanSuccess(Code? value) {
    setState(() async {
      successScans++;
      // var qrBytes = convertUint8ListToString(value.rawBytes);
      // var url = Uri.http('192.168.148.180:8080', 'api/decode');
      // var response = await http.post(url, body: {'raw_bytes': qrBytes});
      // print('Response status: ${response.statusCode}');
      // print('Response body: ${response.body}');

      // result = value?.rawBytes.toString();
